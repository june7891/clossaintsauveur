...
<h1 class="titles">Mentions legales</h1>
...
<div class="container-fluid">
    <div class="m-5 row">
        ...
        <div class="col-md-6">
            ...
            <p>Toma Juneviciute - <a href="www.tomajune.com">www.tomajune.com</a></p>
        ...
        <p>Le site et chacun des éléments, y compris mais sans limitation les marques, les logos, icônes, 
            ...
            de la propriété intellectuelle. Les contenus figurant sur le site sont la propriété de Gabija Urmonaite Roux. Toute utilisation, 
            reproduction ou représentation, par quelque procédé que ce soit, et sur quelque support que ce soit, 
            de tout ou partie du site et/ou des éléments qui le composent n'est pas autorisée sans le consentement expresse de Gabija Urmonaite Roux.</p>

        <h4 class="text-center mb-4">Données personnelles</h4>
        <p>D'une façon générale, vous pouvez visiter notre site sur Internet sans avoir à décliner votre identité et à fournir des informations personnelles vous concernant.
        Cependant, nous pouvons parfois vous demander des informations. Par exemple, pour établir une correspondance.
        </p>

        <h4 class="text-center mb-4">Liens</h4>
        <p>Le site peut inclure des liens vers d'autres sites Web ou d'autres sources internet. Dans la mesure où Clos Saint Sauveur ne peut contrôler ces sites et ces sources externes, Clos Saint Sauveur ne peut être tenu pour responsable de la mise à disposition de ces sites et sources externes, et ne peut supporter aucune responsabilité quant au contenu, publicités, produits, services ou tout autre matériel disponible sur ou à partir de ces sites ou sources externes.</p>
    </div>
</div>
